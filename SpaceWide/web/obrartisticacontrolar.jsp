    ...
    <%@include file="menu.jsp"%>
            ...
            <th colspan="2">Ações:</th></tr>
                ...
                <tr>
                    ...
                    <td><a href="editar/Obrabloquear.jsp?id=${obra.getId()}&estado=${obra.getEstado()}"> <i class="material-icons middle">lock</i></a></td>
                    <td><a href="editar/Obraexcluir.jsp?id=${obra.getId()}" ><i class=" material-icons middle" onclick="return confirm('Deseja deletar?');">delete</i></a></td>
                </tr>	
                </c:forEach>
            </table>
                </div> 
